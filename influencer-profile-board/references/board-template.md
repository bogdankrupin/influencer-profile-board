...
Guidance for rendering the profile board as one polished, self-contained HTML
...
4. **Expertise** — core topics as filterable chips; sub-themes and formats as a short list.
5. **Notable work & links** — a list/grid of cards: title, one-liner, outbound link.
